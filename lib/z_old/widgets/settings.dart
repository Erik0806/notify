...
import 'package:notify/z_old/widgets/setting_button.dart';
      ...
      child: ListView(
        children: [
          SettingButton(
            ...
            child: ToggleSwitch(
              initialLabelIndex: Get.find<Controller>()
                          .sharedPreferences
                          .getBool('neueNotiz') ??
                      true
                  ? 0
              ...
              onToggle: (index) {
                if (index == 0) {
                  Get.find<Controller>().sharedPreferences.setString(
                      'notizenLöschenNach',
                      const Duration(hours: 12).toString());
          ...
          SettingButton(
            ...
            child: DayNightSwitcher(
              ...
              isDarkModeEnabled: Get.find<Controller>()
                      .sharedPreferences
                      .getBool('darktheme') ??
                  false,
